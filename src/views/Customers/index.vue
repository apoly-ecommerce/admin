  ...
  <section class="PageRole">
    ...
    <template>
      ...
      <template v-slot:tools>
        <router-link class="Table__tools-item" :to="{ name: 'add-role' }">Add Customer</router-link>
      </template>
...
<script>
// Configs Paginate of Page customer.
...
export default {
  ...
  data() {
    return {
      paginateCustomer: paginates.customer,
      fields: [
  ...
  computed: {
    ...
    getPagination() {
      return {
        ...
        perPage: this.paginateCustomer.perPage,
        options: this.paginateCustomer.options,
        currentPage: this.paginateCustomer.currentPage
      };
    }
  },
  methods: {
    handlePagination({ page, perPage }) {
      this.paginateCustomer.currentPage = page;
      this.paginateCustomer.perPage = perPage;
    }
  }
}
</script>