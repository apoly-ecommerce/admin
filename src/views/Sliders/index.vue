  ...
  <section class="PageUser">
    ...
    <page-table-content :tableName="tableName">
      <template v-slot:tools>
        ...
        <router-link class="Table__tools-item" :to="{ name: 'add-slider' }">Thêm mới</router-link>
      </template>
      ...
      <template v-slot:main-content>
        <section class="TableBox_Content">
          ...
          >
            ...
            <el-table-column label="Mobile" prop="mobile_image" width="200">
              <template slot-scope="{row}">
                <div class="TableThumb_ThumbImage" style="height: 50px; width: 100%;">
                  <img :src="row.mobile_image" alt="" class="h-100" style="width: auto;">
                </div>
              </template>
            </el-table-column>

            <el-table-column label="Detail" prop="detail" width="220" sortable>
              <template slot-scope="{row}">
            ...
            <el-table-column label="Slider" prop="feature_image" width="200">
              <template slot-scope="{row}">
                <div class="TableThumb_ThumbImage" style="height: 50px; width: 100%;">
            ...
            <el-table-column label="Options" prop="options" width="320" sortable>
              <template slot-scope="{row}">
                <div class="line-txt-top">
                  <span>Title text color:</span>
                  <strong>{{ row.title_color || '' }}</strong>
                </div>
                <div class="line-txt-top">
                  <span>Sub title text color:</span>
                  <strong>{{ row.sub_title_color || 0 }}</strong>
                </div>
                <div class="line-txt-top">
                  <span>Alternative Color:</span>
                  <strong>{{ row.alt_color || '' }}</strong>
                </div>
                <div class="line-txt-top">
                  <span>Link:</span>
...
export default {
  ...
  methods: {
    ...mapActions({
        'fetchListSliderByPaginate': 'slider/fetchListSliderByPaginate',
        'trashSlider': 'slider/trashSlider',
        'massTrashSlider': 'slider/massTrashSlider',
        'fetchListSliderTrashedByPaginate': 'slider/fetchListSliderTrashedByPaginate',
        'destroySlider': 'slider/destroySlider',
        'massDestroySlider': 'slider/massDestroySlider',
        'restoreSlider': 'slider/restoreSlider',
        'massRestoreSlider': 'slider/massRestoreSlider',
        'emptyTrashSlider': 'slider/emptyTrashSlider'
    }),
    formatTime(time) {
