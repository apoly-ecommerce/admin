  ...
  computed: {
    ...
    getPagination() {
      return {
        ...
        perPage: this.paginateRole.perPage,
        options: this.paginateRole.options,
        currentPage: this.paginateRole.currentPage
      };
    }
  },
  methods: {
    handlePagination({ page, perPage }) {
      this.paginateRole.currentPage = page;
      this.paginateRole.perPage = perPage;
    }
  }
}
</script>